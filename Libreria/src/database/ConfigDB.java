...
public class ConfigDB {
    ...
    public  static  Connection openConnection(){
        ...
        try{
            ...
            String url = "jdbc:mysql://buorjrjxhfmqwii19buh-mysql.services.clever-cloud.com/buorjrjxhfmqwii19buh";
            String user = "up6s2ibv0emqhsff";
            String password = "1zhQoqEZ50thb9HBlcxs";
